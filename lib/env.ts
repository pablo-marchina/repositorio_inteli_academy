...
const serverSchema = z.object({
  ...
  GOOGLE_DRIVE_ROOT_FOLDER_ID: z.string().min(1).default("1UNwO3RgmjCshbVUoxsoFSLmxFFlOrkhH"),
  FIGMA_ACCESS_TOKEN: z.string().min(1).optional(),
  FIGMA_FILE_KEY: z.string().min(22).default("xFV6r1G9gMjWvLf7gqyuYo"),
  FIGMA_OUTPUT_PAGE_NAME: z.string().min(1).default("Academy • Gerações"),
  FIGMA_PLUGIN_SECRET: z.string().min(24).optional(),
